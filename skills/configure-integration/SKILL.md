...
> **Note**: These are static IAM credentials. Plugin users use static keys because they do not have access to Breitling SSO infrastructure. The minimum required IAM policy is `sts:GetCallerIdentity`.
